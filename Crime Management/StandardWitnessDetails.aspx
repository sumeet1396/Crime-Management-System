<%@ Page Title="" Language="C#" MasterPageFile="~/StandardUserMasterPage.master" AutoEventWireup="true" CodeFile="StandardWitnessDetails.aspx.cs" Inherits="StandardWitnessDetails" %>
...
<div style="width:80%; height:100%; position:relative; left:20%;">
        <center>
            ...
            <asp:TableRow>
             ...
             <h3>Related Cases</h3>
            <p>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="case_ID" DataSourceID="relatedcase" BorderColor="White">
                    <Columns>
