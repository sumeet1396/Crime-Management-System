...
public partial class CaseDescription : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int ctid = Convert.ToInt32(ds.Tables[0].Rows[0]["crimetypeID"].ToString());
        string getData1 = "select * from crime_type where crimetypeID=" + ctid;
        SqlCommand com = new SqlCommand(getData1, con);
        SqlDataAdapter da = new SqlDataAdapter();
        DataSet ds7 = new DataSet();
        da.SelectCommand = com;
        da.Fill(ds7);
        Label3.Text = ds7.Tables[0].Rows[0]["crimeSpecification"].ToString();
