<%@ Page Title="" Language="C#" MasterPageFile="~/StandardUserMasterPage.master" AutoEventWireup="true" CodeFile="StandardUserDashboard.aspx.cs" Inherits="StandardUserDashboard" %>
   ...
   <center><h1>DASHBOARD</h1></center>
    <div class="block1" style="color:black">
        ...
        <div class="block2">
            ...
            <div class="sub-b2">
                 <center><h2>No of Criminals in Jail</h2></center>
                <div class="t3">
                     <br />
                    <table style="margin-left:40px;">
