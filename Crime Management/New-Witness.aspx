<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="New-Witness.aspx.cs" Inherits="New_Witness" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div style="width:80%; height:100%; position:relative; left:20%;">
      <center><h1>New Witness</h1></center>
    <br /><br />
    <div>
        <center>
        <asp:Table ID="Table1" runat="server" Height="226px" Width="631px">
            ...
            <asp:TableRow>
                <asp:TableCell>
                        <asp:TextBox ID="TextBox7" runat="server" TextMode="MultiLine"  Width="180%" Height="100px"></asp:TextBox><br />
            ...
            <asp:TableRow>
                <asp:TableCell>
                        <asp:Label ID="Label11" runat="server" Text="Witness Photo"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
