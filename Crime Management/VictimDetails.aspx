<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VictimDetails.aspx.cs" Inherits="VictimDetails" %>
    ...
    <center>
        ...
        <asp:Table ID="Table1" runat="server" Height="272px" Width="700px">
            ...
            <asp:TableRow>
             ...
             <br /><br />
             <h3>Related Cases</h3>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="case_ID" DataSourceID="SqlDataSource1">
                    <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CrimeDBConnectionString %>" SelectCommand="SELECT [case_ID], [caseName], [crimetypeID], [criminal_id] FROM [CaseEntries] WHERE ([victim_id] = @victim_id)">
            <SelectParameters>
                <asp:SessionParameter Name="victim_id" SessionField="getVictimData" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    </center>
         </div>
